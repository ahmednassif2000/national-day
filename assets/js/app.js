...
$("input[type=radio]").on("click", function () {
    ...
    if (script != '') {
        ...
        if (script == 'script-14') { scriptImg = "assets/images/scripts/1626271790.png"; }
        if (script == 'script-13') { scriptImg = "assets/images/scripts/1626271760.png"; }
        if (script == 'script-16') { scriptImg = "assets/images/scripts/1626271844.png"; }
        if (script == 'script-17') { scriptImg = "assets/images/scripts/1626271868.png"; }
        if (script == 'script-18') { scriptImg = "assets/images/scripts/1626271897.png"; }
        if (script == 'script-19') { scriptImg = "assets/images/scripts/1626271926.png"; }
        if (script == 'script-20') { scriptImg = "assets/images/scripts/1626271947.png"; }
        if (script == 'script-21') { scriptImg = "assets/images/scripts/1626271968.png"; }
        if (script == 'script-22') { scriptImg = "assets/images/scripts/1626271996.png"; }


        const img = new Image()
        img.src = scriptImg
        img.onload = () => {
            ctx.drawImage(img, 325, 750);
            // drawmessage(message, ctx);
            drawname(ctx);
        }
        // draw snap
        ...
        imgSnap.onload = () => {
            ctxSnap.drawImage(imgSnap, 325, 1350);
            // drawmessageSnap(message, ctxSnap);
            drawnameSnap(ctxSnap);
        }
...
function drawmessage() {
    ...
    if (selectedRadio) {
        ...
        ctx.fillText(messageImg, pos1, 650);
